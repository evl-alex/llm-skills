...
3. **Language.** Work and respond in English throughout. If the user describes the idea in another language, understand it and continue in English so the whole brief stays consistent for downstream LLM use.
